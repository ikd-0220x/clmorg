...
export default function Docs() {
  ...
  <meta name="description" content="CLM platformasidan qanday foydalanish bo‘yicha qo‘llanma. Qadam-baqadam tushuntirishlar." />
</Helmet>
<div className="flex flex-col justify-center items-center p-6 bg-gray-100 text-left ">
      ...
      <div className="max-w-3xl text-justify mb-8 text-gray-800 relative">
        <p className={`text-lg transition-all duration-300 ease-in-out ${showFullText ? "" : "line-clamp-4"}`}>
          {t("docsText")}
        </p>
