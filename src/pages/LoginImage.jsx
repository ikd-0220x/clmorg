...
const LoginImage = () => {
  ...
  <meta name="description" content="CLM platformasiga kirish uchun login sahifasi. Profilingizga kiring va obunachilar yig‘ishni boshlang." />
</Helmet>
<div className="flex justify-center items-center h-screen bg-cover bg-center relative" style={{ backgroundImage: "url('/logistika.jpg')" }}>
      ...
      <div className="relative w-[400px] p-8 backdrop-blur-xl border border-white rounded-xl shadow-lg text-white flex flex-col items-center">
        ...
        <p className="mt-6 text-lg">Don't have an account?
          <Link to='/register' className="font-bold hover:underline ml-2">Register</Link>
        </p>
      </div>
    </div>
    </div>
